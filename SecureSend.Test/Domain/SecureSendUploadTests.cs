...
public class SecureSendUploadTests
{
    ...
    {
        upload.AddFile(new SecureSendFile("test_file", "application/octet-stream", 2222222222));
    ...
    public void AddMultipleFiles_Succeeds()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            files.Add(new SecureSendFile($"{i}_test_file", "application/octet-stream", 2222222222));
        }
    ...
    {
        upload.AddFile(new SecureSendFile("test_file", "application/octet-stream", 2222222222));
        var exception = Record.Exception(() => upload.AddFile(new SecureSendFile("test_file", "application/octet-stream", 2222222222)));
