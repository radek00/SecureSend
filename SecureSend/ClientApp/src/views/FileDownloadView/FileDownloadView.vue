...
<template>
  <div class="flex justify-center items-center mt-14 md:mt-20">
    ...
    >
      <div
        class="w-full p-6 rounded-lg shadow-sm border md:mt-0 sm:max-w-md bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 sm:p-8"
      >
        <h2
          class="mb-1 text-xl font-bold leading-tight tracking-tight md:text-2xl text-gray-900 dark:text-white"
        >
          Unlock your files
        </h2>
        <form
