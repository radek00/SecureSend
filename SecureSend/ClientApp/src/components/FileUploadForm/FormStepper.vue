<template>
    <ol class="flex items-center w-full">
        <li :class="{ 'text-blue-600 dark:text-blue-500 dark:after:border-blue-800 after:border-blue-100 ': step === 0, 'after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700 ': step !== 0 }"
            ...
            <span class="flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12  shrink-0"
                :class="{ 'dark:bg-blue-800 bg-blue-100': step === 0, 'dark:bg-gray-700 bg-gray-100': step !== 0 }">
        ...
        <li :class="{ 'text-blue-600 dark:text-blue-500 dark:after:border-blue-800 after:border-blue-100 ': step === 1, 'after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700 ': step !== 1 }"
            class="flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-4 after:inline-block">
            <span class="flex items-center justify-center w-10 h-10  rounded-full lg:h-12 lg:w-12 shrink-0"
                :class="{ 'dark:bg-blue-800 bg-blue-100': step === 1, 'dark:bg-gray-700 bg-gray-100': step !== 1 }">
            ...
            <span class="flex items-center justify-center w-10 h-10 rounded-full lg:h-12 lg:w-12 shrink-0"
                ...
                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M8 1v11m0 0 4-4m-4 4L4 8m11 4v3a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-3"></path>
                </svg>
            </span>
        </li>
    </ol>
